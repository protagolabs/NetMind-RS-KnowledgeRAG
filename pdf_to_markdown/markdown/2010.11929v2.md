...
![](https://netmind-public-files.s3.us-west-2.amazonaws.com/22260a2ae5f14834a00e0220e93680a0/32d43307cd90297c280c91b12aeea78d2fddad4c43f3018e15d950688f742055.jpg)  
...
Similar to BERT’s [class] token, we prepend a learnable embedding to the sequence of embedded patches $(\mathbf{z}_{0}^{0}=\mathbf{x}_{\mathrm{class}})$ , whose state at the output of the Transformer encoder $(\mathbf{\bar{z}}_{L}^{0})$ serves as the image representation y (Eq. 4). Both during pre-training and fine-tuning, a classification head is attached to $\mathbf{z}_{L}^{0}$ . The classification head is implemented by a MLP with one hidden layer at pre-training time and by a single linear layer at fine-tuning time.  
...
$$
\begin{array}{r l}&{\mathbf{z}_{0}=[\mathbf{x}_{\mathrm{class}};\mathbf{x}_{p}^{1}\mathbf{E};\mathbf{x}_{p}^{2}\mathbf{E};\dots;\mathbf{x}_{p}^{N}\mathbf{E}]+\mathbf{E}_{p o s},\qquad\mathbf{E}\in\mathbb{R}^{(P^{2}\cdot C)\times D},\mathbf{E}_{p o s}\in\mathbb{R}^{(N+1)\times D}}\\ &{\mathbf{z}^{\prime}\ell=\mathrm{MSA}(\mathrm{LN}(\mathbf{z}_{\ell-1}))+\mathbf{z}_{\ell-1},}\\ &{\mathbf{z}_{\ell}=\mathrm{MLP}(\mathrm{LN}(\mathbf{z}^{\prime}\ell))+\mathbf{z}^{\prime}\ell,}\\ &{\mathbf{y}=\mathrm{LN}(\mathbf{z}_{L}^{0})}\end{array}
$$  
...
![](https://netmind-public-files.s3.us-west-2.amazonaws.com/22260a2ae5f14834a00e0220e93680a0/48ba20ff407db23c0548e53c318e2d88d82a2eccb6ea94113438222aae1542cb.jpg)  
...
![](https://netmind-public-files.s3.us-west-2.amazonaws.com/22260a2ae5f14834a00e0220e93680a0/47be2b662d27a13280030c4ef3ea3c8d9782336dad35bf875247fb29d2e4954c.jpg)  
Figure 3: Transfer to ImageNet. While large ViT models perform worse than BiT ResNets (shaded area) when pre-trained on small datasets, they shine when pre-trained on larger datasets. Similarly, larger ViT variants overtake smaller ones as the dataset grows.  

![](https://netmind-public-files.s3.us-west-2.amazonaws.com/22260a2ae5f14834a00e0220e93680a0/7cc1dacc932dffbb66d316ff9fc2d42f646fc9f93e94d99fc7a4107c330074a3.jpg)  
Figure 4: Linear few-shot evaluation on ImageNet versus pre-training size. ResNets perform better with smaller pre-training datasets but plateau sooner than ViT, which performs better with larger pre-training. ViT-b is ViT-B with all hidden dimensions halved.  

![](https://netmind-public-files.s3.us-west-2.amazonaws.com/22260a2ae5f14834a00e0220e93680a0/dfc942a4fc7d81ff89da07ddf861b6716a86fa14de1e39de9789728797dc6271.jpg)  
...
![](https://netmind-public-files.s3.us-west-2.amazonaws.com/22260a2ae5f14834a00e0220e93680a0/582180d29dfb1cd1343f8f72b55e1640fa81263baea5f5e16b0eda0979d1d6cc.jpg)  
...
![](https://netmind-public-files.s3.us-west-2.amazonaws.com/22260a2ae5f14834a00e0220e93680a0/702e35145cffb3bafb21e859fa2b110683e9062c5d2f74646d2cea7bb5707831.jpg)  
...
Olivier J. He´naff, Aravind Srinivas, Jeffrey De Fauw, Ali Razavi, Carl Doersch, S. M. Ali Eslami, and Aaron van den Oord. Data-efficient image recognition with contrastive predictive coding. In  
...
Xiaohua Zhai, Avital Oliver, Alexander Kolesnikov, and Lucas Beyer. $\mathrm{\bfS^{4}L}$ : Self-Supervised SemiSupervised Learning. In ICCV, 2019a.   
...
Table 3: Hyperparameters for training. All models are trained with a batch size of 4096 and learning rate warmup of $10\mathrm{k}$ steps. For ImageNet we found it beneficial to additionally apply gradient clipping at global norm 1. Training resolution is 224.   
...
| R50x{1,2} | JFT-300M | 7７ | 10-3 | linear | 0.1 | 0.0 |
...
$$
\begin{array}{r l}&{[\mathbf{q},\mathbf{k},\mathbf{v}]=\mathbf{z}\mathbf{U}_{q k v}\qquad\mathbf{U}_{q k v}\in\mathbb{R}^{D\times3D_{h}},}\\ &{\qquadA=\mathrm{softmax}\left(\mathbf{q}\mathbf{k}^{\top}/\sqrt{D_{h}}\right)\qquad\qquadA\in\mathbb{R}^{N\times N},}\\ &{\qquad\mathrm{SA}(\mathbf{z})=A\mathbf{v}.}\end{array}
$$  
...
$$
\begin{array}{r}{\mathrm{MSA}(\mathbf{z})=[\mathrm{SA}_{1}(z);\mathrm{SA}_{2}(z);\cdot\cdot\cdot;\mathrm{SA}_{k}(z)]\mathbf{U}_{m s a}\qquad\quad\mathbf{U}_{m s a}\in\mathbb{R}^{k\cdot D_{h}\times D}}\end{array}
$$  
...
| Oxford-IIIT-Pets | 93.81 | 92.04 | 93.64 | 91.35 | 一 |
...
| Oxford Flowers-102 Oxford-IIIT-Pets | 99.38 | 99.11 | 99.61 | 99.19 | 99.51 |
|  | 94.43 | 93.02 | 94.73 | 93.09 | 94.82 |
...
| name ViT-B/32 | ？ | 80.73 | 86.27 | 98.61 | 90.49 | 93.40 | 99.27 | 55 |
...
![](https://netmind-public-files.s3.us-west-2.amazonaws.com/22260a2ae5f14834a00e0220e93680a0/e3d4a8ae9b0038c36053dc08e05ea07f13457c18927327cd638acd901a06effb.jpg)  
...
![](https://netmind-public-files.s3.us-west-2.amazonaws.com/22260a2ae5f14834a00e0220e93680a0/8e18fc983cbdf05fafad4a3db29ba399032368402aaa9f4020f49974b73248d7.jpg)  
...
![](https://netmind-public-files.s3.us-west-2.amazonaws.com/22260a2ae5f14834a00e0220e93680a0/b9c981f6f7595c7f45fc2cf6b0cd0b3c9b70fb74def18cb181e6570833c07f1f.jpg)  
...
![](https://netmind-public-files.s3.us-west-2.amazonaws.com/22260a2ae5f14834a00e0220e93680a0/06ff59f071faef73b10838f6978245dae66fa3a180df3bd653f8b06bb566330c.jpg)  
...
![](https://netmind-public-files.s3.us-west-2.amazonaws.com/22260a2ae5f14834a00e0220e93680a0/a8e146bee365f14d85193842a8bed90b7cee0cc13aafbd0e917ae99f586a7d1b.jpg)  
...
![](https://netmind-public-files.s3.us-west-2.amazonaws.com/22260a2ae5f14834a00e0220e93680a0/1b380dea9c6098fe16fc9688df4af42e09aa4899621baa54611dc7d8557baa10.jpg)  
...
![](https://netmind-public-files.s3.us-west-2.amazonaws.com/22260a2ae5f14834a00e0220e93680a0/b465eb86a4d05da6c45bdd777af4fd72297a30b64e79fc61e639e238ed883f17.jpg)  
...
| | | | | | | | | | | | | | | | | | | | | |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
|  |  |  | · |  |  |  | L6Euns· | NHAS· |  |  |  |  |  |  |  | DoT-Idsp· | O-Jdsp· |  |  |  |
| ViT-H/14 (JFT) | 95.3 | 85.5 | 75.2 | 99.7 | 97.2 |  | 65.0 | 88.9 | 83.3 | 96.7 | 91.4 | 76.6 91.7 | 63.8 | 53.1 | 79.4 | 63.3 | 84.5 | 33.2 51.2 |  | 77.6 |
| ViT-L/16 (JFT)95.4 81.9 |  |  | 74.3 |  | 99.796.7 |  | 63.587.4 |  | 83.6 96.5 89.7 |  | 77.1 |  |  | 86.4 63.1 49.774.560.5 82.236.2 51.1 |  |  |  |  |  | 76.3 |
| ViT-L/16 (I21k)90.8 |  | 84.1 | 74.1 |  | 99.392.7 | 61.0 | 80.9 |  | 82.5 95.6 85.2 75.3 |  |  | 70.3 |  | 56.1 41.9 | 74.7 | 64.9 | 79.9 | 30.5 | 41.7 | 72.7 |
